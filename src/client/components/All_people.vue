<template>
  <div id="All_people">
      ...
      <div class="ui special cards">
        <div class="card">
          <div class="blurring dimmable image">
            ...
            <div class="content">
              <div class="center">
                <div class="ui inverted button info" v-on:click="show">Info</div>
              </div>
            </div>
            </div>
          ...
          <div class="content">
            ...
            <div class="meta">
            <span class="date">Major in Information & Inductional Management</span>
            </div>
          </div>
    ...
    <div class="ui modal personalInfo">
